...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/input__accountname'), findTestData('D5').getValue(1, 1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/input Customer Segment'), findTestData('D5').getValue(2, 1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/New Select/input Company level 1'), findTestData('D5').getValue(3, 
        1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/input japanese'), findTestData('D5').getValue(4, 1))

WebUI.sendKeys(findTestObject('Not in DBD/Page_Accounts/input japanese'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Purchasing'), findTestData('D5').getValue(5, 1))

WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Branch ID'), findTestData('D5').getValue(6, 1))

WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Phone'), 'lol')

WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Address'), findTestData('D5').getValue(7, 1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Tax NO'), findTestData('D5').getValue(9, 1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Phone'), findTestData('D4').getValue(12, 1))
